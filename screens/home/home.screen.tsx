...
import useTransactionStore, { initilizeTransaction } from '@/store/transaction.store';
    ...
    <Screen className='relative'>
      <GestureHandlerRootView className='flex-1'>
        ...
        <View className='px-2 pt-8 flex-1'>
          ...
          <FlatList
            onRefresh={initilizeTransaction}
            refreshControl={<RefreshControl refreshing={false} onRefresh={initilizeTransaction} />}
            data={transactions}
            renderItem={({ item }) => (
